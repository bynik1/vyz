...
function clockTick() {
    ...
    let ampm = hour >= 12 ? dg7.src=dgpm.src : dg7.src=dgam.src;
    hour = hour % 12;

    setRis(hour.charAt(0),dg1);//Метод charAt()возвращает указанный символ из строки.
    setRis(hour.charAt(1),dg2);
    setRis(minute.charAt(0),dg3);
    setRis(minute.charAt(1),dg4);
    setRis(secunde.charAt(0),dg5);
    setRis(secunde.charAt(1),dg6);
