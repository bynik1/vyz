...
private:
    ...
    static unsigned long count;//статические

public:
    list(): first(nullptr), last(nullptr), size(0)//список инциализации инциализирует элементы до самого тела функции
    {
        list::setcount(list::getcount() + 1);//тело
    }
